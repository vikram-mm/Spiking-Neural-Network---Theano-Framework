...
class mnist_data_set():
    ...
    def __init__(self, data_path, batch_size = 1,
        ...
        self.data_sets = {
			...
			'test' : data_set(X_test,Y_test,batch_size,True)#,
	...
	for f in os.listdir(files):
	    ...
	    ans.append(X)
	    #print(X.shape)
	return np.squeeze(np.array(ans),axis=1),(np.array(labels))
	...
	train_X,train_y = self.load_mnist_images(self.data_path)
	test_X,test_y = self.load_mnist_images('/data3/deepak_interns/vikram/Face_Mbike_testset/')
