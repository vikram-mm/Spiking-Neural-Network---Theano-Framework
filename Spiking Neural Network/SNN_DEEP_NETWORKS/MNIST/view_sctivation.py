...
if __name__ =='__main__' :
	...
	for i, (X,Y) in enumerate(datasets['train']):
	    ...
	    plot_weights(dog_map,plot_name=str(i)+'dog', file_path ='./models/plots/activation')
	    for j,test_func in enumerate(network.test_funcs):
		    ...
		    plot_weights(output,plot_name=str(i)+'output_spike_seperate'+'_stage_'+str(j), file_path ='./models/plots/activation')
